...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`https://myblog-api-flame.vercel.app/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`https://myblog-api-flame.vercel.app/story/${slug}/edit`, formdata, config)
                    ...
                    <div className="Inclusive-editStory-page ">
                        <form onSubmit={handleSubmit} className="editStory-form">
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={`https://myblog-api-flame.vercel.app/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
