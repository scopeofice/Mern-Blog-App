...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`mern-blog-app-psi.vercel.app/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`mern-blog-app-psi.vercel.app/story/${slug}/edit`, formdata, config)
                    ...
                    <div className="Inclusive-editStory-page ">
                        <form onSubmit={handleSubmit} className="editStory-form">
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={`mern-blog-app-psi.vercel.app/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
