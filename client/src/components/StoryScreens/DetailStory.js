...
const DetailStory = () => {
  ...
  useEffect(() => {
    ...
    const getDetailStory = async () => {
      ...
      var activeUser = {}
      try {
        const { data } = await axios.get("http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/auth/private", {
          headers: {
      ...
      try {
        const { data } = await axios.post(`http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/story/${slug}`, { activeUser })
        setStory(data.data)
  ...
  const handleLike = async () => {
    ...
    try {
      const { data } = await axios.post(`http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/story/${slug}/like`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
  ...
  const handleDelete = async () => {
    ...
    if (window.confirm("Do you want to delete this post")) {
      ...
      try {
        ...
        await axios.delete(`http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/story/${slug}/delete`, {
          headers: {
            "Content-Type": "application/json",
            authorization: `Bearer ${localStorage.getItem("authToken")}`,
          },
  ...
  const addStoryToReadList = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/user/${slug}/addStoryToReadList`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
            ...
            <div className='Inclusive-detailStory-page'>
                  ...
                  <ul>
                    {story.author &&
                      <li className='story-author-info'>
                        <img src={`http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/userPhotos/${story.author.photo}`} alt={story.author.username} />
              ...
              <div className='story-content' >
                ...
                <div className="story-banner-img">
                  <img src={`http://ec2-13-235-104-208.ap-south-1.compute.amazonaws.com:5000/storyImages/${story.image}`} alt={story.title} />
