...
const AddStory = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post("http://ec2-13-233-56-102.ap-south-1.compute.amazonaws.com:5000/story/addstory", formdata, config)
        ...
        <div className="Inclusive-addStory-page ">
            ...
            <form onSubmit={handleSubmit} className="addStory-form">
                ...
                <div class="StoryImageField">
                    ...
                    <div class="txt">
                        {image ? image.name :
                            " Include a high-quality image/gif in your story to make it more inviting to readers."
                        }
                    </div>
                    <input
                        name="image"
